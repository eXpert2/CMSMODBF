			...
			<div class="padded">
				...
				<div class="row" style="margin-bottom: 2.5em">
					...
					<div class="column size1of2 last-column">
						...
						<span class="big-text"><b><?php echo $deleted_users ?></b></span> &nbsp; <?php echo anchor(SITE_AREA .'/myuser/users/deleted', 'deleted users', 'class="ajaxify"') ?>
					</div>
				</div>


				<div class="box create rounded">
					<a class="button good ajaxify" href="<?php echo site_url(SITE_AREA .'/myuser/users/create'); ?>"><?php echo lang('us_create_user'); ?></a>
