<div class="view split-view">
	...
	<div class="notification attention">
		<p><?php echo lang('role_no_roles'); ?> <?php echo anchor(SITE_AREA .'/myuser/roles/create', lang('role_create_button')) ?></p>
	</div>
	...
	<div id="content" class="view">
		<div class="scrollable" id="ajax-content">
				...
				<div class="box create rounded">
					<a class="button good ajaxify" href="<?php echo site_url(SITE_AREA .'/myuser/roles/create'); ?>"><?php echo lang('role_create_button'); ?></a>
				...
				<?php if (isset($role_counts) && is_array($role_counts) && count($role_counts)) : ?>
					...
					<table cellspacing="0">
						...
						<?php foreach ($roles as $role) : ?>
							<tr>
								<td><?php echo anchor(SITE_AREA .'/myuser/roles/edit/'. $role->role_id, $role->role_name, 'class="ajaxify"') ?></td>
