...
<table cellspacing="0">
        <tbody>
                ...
                <th >
                    ...
                    <!-- <table>
                       ...
                       <tr>
                          ...
                          <td><select name="fldformtype" id="fldformtype" style="width:230px;">
                    ...
                    <div style="margin-top: 2px;" id="ffd2"><input name="fields[]" class="inpflds" readonly="readonly" value="id">&nbsp;<input name="fieldtitles[]" class="inpflds" readonly="readonly" value="ID">&nbsp;<input name="fieldtypes[]" class="inpflds" readonly="readonly" value="idprimautoinc">&nbsp;<input name="fldformtypes[]" class="inpflds" readonly="readonly" value="AutoID">&nbsp;&nbsp;<a href="#"  onclick="alert('Это поле нельзя удалить!')">{X}</a></div>
                    <div style="margin-top: 2px;" id="ffd3"><input name="fields[]" class="inpflds" readonly="readonly" value="title">&nbsp;<input name="fieldtitles[]" class="inpflds" value="Title">&nbsp;<input name="fieldtypes[]" class="inpflds" readonly="readonly" value="varchar">&nbsp;<input name="fldformtypes[]" class="inpflds" readonly="readonly" value="text">&nbsp;&nbsp;<a href="#"  onclick="alert('Это поле нельзя удалить!')">{X}</a></div>
                    </div>
            ...
            <tr>
                <th >
                    Название справочника(EN): <input type="text" name="newtablename" id="newtablename" style="width:100px;">
                    &nbsp; &nbsp;
                    Заголовок справочника: <input type="text" name="newtabletitle" id="newtabletitle" style="width:100px;">
                    &nbsp; &nbsp;
                    <input type="button"  value="Создать справочник" onclick="doformsubmit()" />
...
<?php echo form_open(SITE_AREA .'/infoblocks/infoblocksdics/', array('style' => 'padding: 0')) ?>
<table cellspacing="0">
        <thead>
            <tr>
                <th style="width: 2em">
        ...
        <?php $i=1; foreach ($formtables as $k=> $table) : ?>
            <tr>
                ...
                <td><a href="/<?=SITE_AREA .'/infoblocks/infoblocksdics/reclist/'.$table?>">Записи</a></th>
                <td><a href="/<?=SITE_AREA .'/infoblocks/infoblocksdics/edit/'.$table?>">редактировать</a></td>
                <td></td>
                <td></td>
            </tr>
        <?php endforeach; ?>
