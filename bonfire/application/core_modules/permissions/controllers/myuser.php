...
class Myuser extends Admin_Controller {
	...
	function __construct()
	{
		...
		Assets::add_js($this->load->view('myuser/js', null, true), 'inline');
	}
	...
	public function create()
	{
		if ($this->input->post('submit'))
		{
			if ($this->save_permissions())
			{
				...
				Template::redirect(SITE_AREA .'/myuser/permissions');
			}
			else
			{
		...
		Template::set_view('myuser/permission_form');
		Template::render();
	}
	...
	public function edit()
	{
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/myuser/permissions');
		}
