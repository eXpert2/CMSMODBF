...
<?php if (isset($backups) && is_array($backups) && count($backups) > 0) : ?>
	<?php echo form_open(SITE_AREA .'/mydbase/database/delete', array('style' => 'padding: 0')); ?>
		<table cellspacing="0">
			<thead>
				<tr>
				...
				<tr class="hover-toggle">
					...
					<td>
						...
						<div class="hover-item small">
							<a href="/admin/mydbase/database/get_backup/<?php echo $file ?>" title="Download this file"><?php echo lang('bf_action_download'); ?></a> |
							<a href="/admin/mydbase/database/restore/<?php echo $file ?>" title="Restore this file"><?php echo lang('db_restore'); ?></a>
						</div>
					</td>
