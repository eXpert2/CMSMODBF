...
<?php echo form_open($this->uri->uri_string(), 'class="constrained ajax-form"'); ?>
	...
	<fieldset>
		...
		<?php echo modules::run('roles/myuser/matrix'); ?>

	</fieldset>

	<div class="text-right">
		<br/>
		<input type="submit" name="submit" value="<?php echo lang('role_save_role'); ?>" /> or <?php echo anchor(SITE_AREA .'/myuser/roles', lang('bf_action_cancel')); ?>
	</div>
	...
	<div class="box delete rounded">
		<a class="button" id="delete-me" href="<?php echo site_url(SITE_AREA .'/myuser/roles/delete/'. $role->role_id); ?>" onclick="return confirm('Are you sure you want to delete this role?')"><?php echo lang('role_delete_role'); ?></a>
