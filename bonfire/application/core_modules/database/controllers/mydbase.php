...
class Mydbase extends Admin_Controller {
	...
	public function __construct()
	{
		...
		Template::set_block('sub_nav', 'mydbase/_sub_nav');
	...
	public function index()
	{
		...
		{
			Template::set('toolbar_title', 'Управление БД');
		}
		Template::render();
	...
	public function backups()
	{
		...
		Template::set('toolbar_title', 'Бекапы БД');
		Template::render();
	}
	...
	public function backup($tables=null)
	{
		...
		} else if (isset($_POST['submit']))
		{
			...
			redirect(SITE_AREA .'/mydbase/database');
		}
	...
	public function get_backup($filename=null)
	{
		...
		} else 	// File doesn't exist
		{
			...
			redirect(SITE_AREA .'/mydbase/database/backups');
		}
	}
	...
	public function restore($filename=null)
	{
		...
		Template::set_view('mydbase/restore');
		Template::set('toolbar_title', 'Восстановление из бекапа');
		Template::render();
	}
	...
	public function delete()
	{
		...
		if (isset($_POST['checked']) && is_array($_POST['checked']) && count($_POST['checked']) > 0)
		{
			...
			Template::set('toolbar_title', 'Удаление бекап файлов БД');
			Template::render();
	...
	public function optimize()
	{
		...
		redirect(SITE_AREA .'/mydbase/database', 'location');
	}
	...
	public function drop($tables=null)
	{
		if (!empty($tables))
		{
			...
			Template::set_view('mydbase/drop');
			return true;
