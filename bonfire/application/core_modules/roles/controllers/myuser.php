...
class Myuser extends Admin_Controller {
	...
	public function __construct()
	{
		...
		Assets::add_js($this->load->view('myuser/roles_js', null, true), 'inline');
	...
	public function index()
	{
		...
		Template::set('toolbar_title', 'Управление ролями');
		Template::render();
	}
	...
	public function create()
	{
		if ($this->input->post('submit'))
		{
			if ($this->save_role())
			{
				...
				Template::redirect(SITE_AREA .'/myuser/roles');
			}
			else
			{
		...
		Template::set_view('myuser/role_form');
		Template::render();
	}
	...
	public function edit()
	{
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/myuser/roles');
		}
	...
	public function matrix()
	{
		...
		// and return it!
		return $this->load->view('myuser/matrix', array('domains' => $domains), true);
	}
