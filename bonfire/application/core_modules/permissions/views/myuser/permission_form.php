...
<div>
	...
	<div class="text-right">
		<br/>
		<input type="submit" name="submit" value="<?php echo lang('permissions_save');?>" /> or <?php echo anchor(SITE_AREA .'/myuser/permissions', lang('permissions_cancel')); ?>
	</div>

	<?php if (isset($permissions)) : ?>
	<div class="box delete rounded">
		<a class="button" id="delete-me" href="<?php echo site_url(SITE_AREA .'/myuser/permissions/delete/'. $id); ?>" onclick="return confirm('<?php echo lang('permissions_delete_confirm'); ?>')"><?php echo lang('permissions_delete_record'); ?></a>
