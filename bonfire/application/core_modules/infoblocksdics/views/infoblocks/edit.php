...
<?php echo form_open(SITE_AREA .'/infoblocks/infoblocksdics/edit/'.$activetbl, array('style' => 'padding: 0','id'=>'ffdtbl')) ?>
<table cellspacing="0">
        <tbody>
            <tr>
                <th >
                    ...
                    <? if($tabledata->fieldname=='id' || $tabledata->fieldname=='title'){ ?>
                    href="#"
                    onclick="alert('Это поле нельзя удалить!');return false;"
                    <? }else{ ?>
                    href="<?=SITE_AREA .'/infoblocks/infoblocksdics/'?>deletecolumn/<?=$tabledata->id?>"
            ...
            <tr>
                <th >
                    Переименовать справочник(EN): <input type="text" name="newtablename" id="newtablename" style="width:100px;" value="<?=$activetablenameforrm?>">
                    &nbsp; &nbsp;
                    Заголовок справочника: <input type="text" name="newtabletitle" id="newtabletitle" style="width:100px;" value="<?=$T->title?>">
                    &nbsp; &nbsp;
