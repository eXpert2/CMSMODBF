...
textarea { color:#444; width:240px; height:50px; font-size:11px;padding-left:8px;}
select { color:#444; width:250px;}
input.inpflds {width:150px;}
</style>
<?php echo form_open(SITE_AREA .'/content/datasources/edit/'.$tableID.'/'.$recordID, array('style' => 'padding: 0','id'=>'ffdtbl')) ?>
<table cellspacing="0" >
         <thead>
           <tr>
                       ...
                       ?>
                        ...
                        <tr>
                          ...
                          <td>
                          	...
                          	<input name="saverecord" type="hidden" value="1">
                          </td>
                       </tr>
                    </table>
                </td>
